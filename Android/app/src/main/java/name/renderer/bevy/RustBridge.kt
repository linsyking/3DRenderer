...
object RustBridge {
    ...
    external fun create_bevy_app(asset_manager: AssetManager, surface: Surface, scale_factor: Float, bg_r: Float, bg_g: Float, bg_b: Float, l_r: Float, l_g: Float, l_b: Float): Long
